          ...
          <div className="flex">
            ...
            <div className="flex-1 p-4">
              ...
              <div className="flex gap-4 mb-4">
                ...
                />
                <TimeInput label="To" value={toTime} onChange={setToTime} />
              </div>
              ...
              <Calendar
                ...
                modifiers={{
                  selected: (date: Date) => {
                    if (!calendarState?.from || !calendarState?.to)
                      return false;
                    return (
                      date >= calendarState.from && date <= calendarState.to
                    );
                  },
                  start: (date: Date) =>
                    calendarState?.from
                      ? date.getTime() === calendarState.from.getTime()
                      : false,
                  end: (date: Date) =>
                    calendarState?.to
                      ? date.getTime() === calendarState.to.getTime()
                      : false,
                }}
              />
            </div>
