...
export function QueryLatencyTrends({ latencyTrendsData }: { latencyTrendsData: QueryLatencyTrendsResult[] }) {
  return (
    <Card>
      <CardHeader>
      ...
      <CardContent>
        <div className="h-[300px] w-full">
          <ResponsiveContainer width="100%" height="100%">
            <AreaChart data={latencyTrendsData} margin={{ top: 16, right: 0, left: 0 }}>
